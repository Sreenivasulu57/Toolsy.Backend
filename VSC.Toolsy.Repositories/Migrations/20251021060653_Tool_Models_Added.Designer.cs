...
namespace VSC.Toolsy.Repositories.Migrations
{
    ...
    [Migration("20251021060653_Tool_Models_Added")]
    partial class Tool_Models_Added
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VSC.Toolsy.Common.Models.CoreEntites.Profile", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 10, 21, 6, 6, 51, 749, DateTimeKind.Utc).AddTicks(1945),
                            DateOfBirth = new DateTime(1985, 5, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "admin1@example.com",
                            EmailVerifiedAt = new DateTime(2025, 10, 21, 11, 36, 52, 112, DateTimeKind.Local).AddTicks(8879),
                            FirstName = "Admin1",
                            Gender = 0,
                            IsActive = true,
                            IsDeleted = false,
                            LastName = "Admin1",
                            PasswordHash = "$2a$11$bkepdES2vp0IVtDkL.TjA.UIXlNZWbpeES0./sOwWuPMFLDo6JJfe",
                            PhoneNumber = "1234567890",
                            PhoneVerifiedAt = new DateTime(2025, 10, 21, 11, 36, 52, 112, DateTimeKind.Local).AddTicks(9334),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 10, 21, 6, 6, 52, 112, DateTimeKind.Utc).AddTicks(9630),
                            DateOfBirth = new DateTime(1986, 7, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "admin2@example.com",
                            EmailVerifiedAt = new DateTime(2025, 10, 21, 11, 36, 52, 259, DateTimeKind.Local).AddTicks(407),
                            FirstName = "Admin2",
                            Gender = 1,
                            IsActive = true,
                            IsDeleted = false,
                            LastName = "Admin2",
                            PasswordHash = "$2a$11$eKAPsEgHmz8xgwRs0uxYC.vu.xV04nwiPFcKKuASYLACgy9BuHt4e",
                            PhoneNumber = "0987654321",
                            PhoneVerifiedAt = new DateTime(2025, 10, 21, 11, 36, 52, 259, DateTimeKind.Local).AddTicks(416),
            ...
            modelBuilder.Entity("VSC.Toolsy.Common.Models.CoreEntites.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VSC.Toolsy.Common.Models.CoreEntites.ToolAvailability", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("ToolAvailability");
                });

            modelBuilder.Entity("VSC.Toolsy.Common.Models.CoreEntites.ToolCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("VSC.Toolsy.Common.Models.CoreEntites.ToolSpecification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("VSC.Toolsy.Common.Models.CoreEntites.RefreshToken", b =>
                {
                    b.HasOne("VSC.Toolsy.Common.Models.CoreEntites.Profile", "profile")
                        ...
                        .HasForeignKey("VSC.Toolsy.Common.Models.CoreEntites.RefreshToken", "ProfileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("VSC.Toolsy.Common.Models.CoreEntites.Tool", b =>
                {
                    ...
                    b.HasOne("VSC.Toolsy.Common.Models.CoreEntites.ToolCategory", null)
                        .WithMany("Tools")
            ...
            modelBuilder.Entity("VSC.Toolsy.Common.Models.CoreEntites.ToolAvailability", b =>
                {
                    b.HasOne("VSC.Toolsy.Common.Models.CoreEntites.Tool", "Tool")
                        .WithMany()
            ...
            modelBuilder.Entity("VSC.Toolsy.Common.Models.CoreEntites.ToolCategory", b =>
                {
                    b.HasOne("VSC.Toolsy.Common.Models.CoreEntites.ToolCategory", "ParentCategory")
